...
Jeden plik z rozstrzygnięciami, które obowiązują we wszystkich bajkach. Skille `/bajka` i `/pomysly` czytają go tak samo jak karty postaci. Dopóki punkt ma status **otwarte**, bajki go nie rozstrzygają: nie nazywają dorosłych z imienia, nie mówią, kto jest czyim bratem, nie opisują wspólnego domu.

Jak używać: autor zmienia status na **ustalone** i wpisuje decyzję. Gdy decyzja dotyczy miejsca, szczegóły idą do `miejsca/`, tu zostaje jedno zdanie i odnośnik.
...
| Rodzice i inni dorośli | ustalone | Rodzice są w bajkach z imienia, jako osobne, wymyślone charaktery (nie portrety prawdziwych osób). Każde dziecko ma mamę i tatę; w każdej rodzinie jeden rodzic jest „jak dziecko”, drugi „na odwrót”. Zawody nowoczesne, bez prezesów. Karty i imiona (zatwierdzone przez autorkę): `postacie/dorośli.md`. Dorosły, który gra więcej niż jedną scenę, dostaje pełną kartę w `postacie/<imię>/`; pierwszy jest Tomek, tata Olka (karta i kanon wyglądu, wrzesień 2026). |
...
| Przedszkole | ustalone | Cała czwórka w jednej grupie. Dwie panie: pani Madzia i pani Kasia (charaktery w `postacie/dorośli.md`). W odcinku na sali jest zawsze jedna pani, nie obie naraz (decyzja autorki, wrzesień 2026). Szczegóły miejsca: `miejsca/przedszkole/`. |
| Zwierzęta | ustalone | Luna, biała kotka Zuzi (ragdoll, niebieskie oczy, żywy kot, nie maskotka), **wychodzi z domu**: może pojawić się na placu zabaw, u sąsiadów, na wyjeździe. Inne dzieci nie mają zwierząt. Olek bardzo chce mieć zwierzę (wątek na przyszłość, patrz niżej). |
...
- Świat jest realistyczny: bez magii, bez gadających zwierząt. Luna miauczy, a „mówi” tylko przez Zuzię.
...
- **Dorośli:** mówią jak dorośli; w każdym odcinku z dorosłym jest co najmniej jeden żart dla rodzica oglądającego, którego dziecko nie musi zrozumieć. Takich smaczków może być więcej, im więcej, tym lepiej (decyzja autorki), zawsze w ustach dorosłego i nigdy kosztem tego, co rozumie dziecko. Humor dorosłego bierze się z sytuacji (co robi, co mu nie wychodzi), nie z powtarzanej gadki w stylu zawodu; zawody rodziców są tłem i nie padają w odcinkach (autorka, wrzesień 2026).
- **Dorośli zawsze odpowiadają.** Dziecko, które pyta dorosłego, dostaje odpowiedź. Dorosły może nie znać całej odpowiedzi albo znać ją tylko po części, ale nie zbywa dziecka i nie odkłada odpowiedzi „bo nie ma czasu”. Takich scen w serii nie ma. Jeśli ciekawość dziecka ma wrócić później w odcinku, dziecko nie pyta: patrzy, zapamiętuje i mówi o tym dopiero, gdy zobaczy rzecz drugi raz, najczęściej przyjaciołom.
- **Segment eksperymentu.** Osobny blok po historii (albo wpleciony przed jej końcem jako wyraźna zmiana otoczenia), 0,5 do 1,5 minuty, liczony do łącznego czasu odcinka: historia plus eksperyment mieszczą się razem w 8,5 do 9,5 minuty. Prowadzi go jedno dziecko z czwórki, na zmianę co odcinek (kolejność: Olek, Ada, Antek, Zuzia, potem od nowa), u siebie w domu, z rzeczami, które są w każdym domu. Mówi wprost do widzów: to jedyne miejsce w serii, gdzie ktoś zwraca się do oglądających. Zjawisko zawsze to samo co w historii odcinka; segment pokazuje, jak sprawdzić je w domu, nie powtarza fabuły. Dorosły w segmencie nie mówi; dziecko zaznacza, że robi to z dorosłym. Nazwa robocza segmentu: „Sprawdzamy w domu” (ostateczna do ustalenia razem z nazwą serii). Odcinek bez zjawiska (o emocji) segmentu nie ma (decyzja autorki, wrzesień 2026). Zapis: `odcinki/_szablon/scenariusz.md`, sekcja `## Eksperyment`.
