...
argument-hint: [nazwa miejsca] [--z-opisu | --z-pliku ścieżka | --z-bajki NN]
---
...
4. Sprawdź, czy istniejące bajki w `bajki/` nie opisują tego miejsca inaczej. Jeśli tak, wypisz różnice; autor wybierze.
